...
static void isl29030_report_als(struct isl29030_data *isl, int forced)
{
			     ...
			     const struct i2c_device_id *id)
{
	...
	input_set_capability(isl->dev, EV_MSC, MSC_RAW);
