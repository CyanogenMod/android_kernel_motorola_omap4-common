...
#define OMAP4430_VDD_MPU_OPPNITROSA_UV	1398000		1.2Ghz
...
#define OMAP4430_VDD_MPU_OPPNITRO_UV			1388000		/* 1.0Ghz  */
#define OMAP4430_VDD_MPU_OPPNITROS_UV			1390000		/* 1.1Ghz  */
#define OMAP4430_VDD_MPU_OPPNITROSA_UV		1398000		/* 1.2Ghz  */
#define OMAP4430_VDD_MPU_OPPNITROSB_UV		1410000		/* 1.3Ghz  */
#define OMAP4430_VDD_MPU_OPPNITROSC_UV		1418000		/* 1.4Ghz  */
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	/* Add 1.1Ghz */
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROS_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfa, 0x27, OMAP_ABB_FAST_OPP, 0),
#endif
	/* Add 1.2Ghz */
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSA_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfa, 0x27, OMAP_ABB_FAST_OPP, 0),
#ifdef CONFIG_USE_13_CLOCK
	/* Add 1.3Ghz */
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSBX, 0xfa, 0x27, OMAP_ABB_FAST_OPP, 11270133),
#endif
#ifdef CONFIG_USE_14_CLOCK
	/* Add 1.4Ghz */
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSC_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSBX, 0xfa, 0x27, OMAP_ABB_FAST_OPP, 12621248),
#endif
...
#endif
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSA_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
#ifdef CONFIG_USE_13_CLOCK
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSB_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
#endif
#ifdef CONFIG_USE_14_CLOCK
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSC_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
#endif
};
...
#endif
	/* MPU OPP5 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1200000000, OMAP4430_VDD_MPU_OPPNITROSA_UV),
#ifdef CONFIG_USE_13_CLOCK
	/* MPU OPP4 - OPP-NTSB1 */
...
#ifdef CONFIG_USE_14_CLOCK
	/* MPU OPP4 - OPP-NTSB2 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1400000000, OMAP4430_VDD_MPU_OPPNITROSC_UV),
#endif
	/* L3 OPP1 - OPP50 */
