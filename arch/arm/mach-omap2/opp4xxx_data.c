...
#define OMAP4430_VDD_MPU_OPPNITROSB13_UV		1410000
#define OMAP4430_VDD_MPU_OPPNITROSB14_UV		1428000


struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP50_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP, 0),
#ifndef CONFIG_USE_FREQ_REDUC_MOD
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB13_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSBX, 0xfa, 0x27, OMAP_ABB_FAST_OPP, 11270133),
#endif
#ifdef CONFIG_USE_14_CLOCK
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB14_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSBX, 0xfa, 0x27, OMAP_ABB_FAST_OPP, 11294103),
#endif
...
#ifdef CONFIG_USE_13_CLOCK
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSB13_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
#endif
#ifdef CONFIG_USE_14_CLOCK
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSB14_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
#endif
};
...
#ifdef CONFIG_USE_13_CLOCK
	/* MPU OPP4 - OPP-NTSB1 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1300000000, OMAP4430_VDD_MPU_OPPNITROSB13_UV),
#endif
#ifdef CONFIG_USE_14_CLOCK
	/* MPU OPP4 - OPP-NTSB2 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1400000000, OMAP4430_VDD_MPU_OPPNITROSB14_UV),
#endif
	/* L3 OPP1 - OPP50 */
