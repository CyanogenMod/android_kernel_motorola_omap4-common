 ...
 */
/* TI musb must use 4bit alignment address to conduct DMA transfer.
 * On Linux 3.0.8, buffer returned from skb_alloc() has alread been aligned.
 * If set NET_IP_ALIGN when call skb_alloc(), it will be unaligned.
 * So there is no need to set NET_IP_ALIGN on Linux 3.0.8.
 */
